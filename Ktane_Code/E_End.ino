...
void End() {
  ...
  matrix.fillScreen(0);
  matrix.writeDisplay();
  //printf("Time left: %02d:%02d.%02d", (timer / 60), (timer % 60), (int)((((millisTimer - last_timer_update) / (pow(2, 2 - STRIKES) / (4 - STRIKES)))) / 10));
  ...
  Serial.println("." + (String)((int)(((millisTimer - last_timer_update) / (pow(2, 2 - STRIKES) / (4 - STRIKES))) / 10) < 10 ? "0" : "") + (String)((int)(((millisTimer - last_timer_update) / (pow(2, 2 - STRIKES) / (4 - STRIKES))) / 10)));
